...
const Header = () => {
    AOS.init();
    return (
        <div className='header-container h-screen pt-28  md:pt-0  flex md:items-center bg-cover overflow-hidden'>
            <div className=' grid grid-cols-2 gap-5 container items-center '>
                ...
                <div className="md:col-span-1 col-span-2">
                    <img className='w-auto h-auto  object-contain bg-gray-900 rounded-tl-full rounded-br-full ' src={ProfileLogo} alt="" data-aos="zoom-out-left" />
                </div>
            </div>
        </div>
    );
