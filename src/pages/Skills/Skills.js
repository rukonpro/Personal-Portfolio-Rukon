        ...
        <div id="skills" className=' container-fluid h-screen d-flex justify-center items-center skills-container'>
            <section className=" my-5 " id="Skills">
                ...
                <div className="skills row">
                    <div className="col-sm-12 col-md-6 col-lg-4  " data-aos="zoom-out-right">
                        <h4>HTML5</h4>
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-4  " data-aos="zoom-out-left">
                        <h4>CSS & CSS3</h4>
                        <div className="progress  " >
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-4  " data-aos="zoom-out-right">
                        ...
                        <div className="progress  ">
                            <div className="progress-bar progress-bar-striped bg progress-bar-animated" role="progressbar"
                                style={{ width: '50%' }} aria-valuenow="50" aria-valuemin="0" aria-valuemax="95">50%</div>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-6 col-lg-4  " data-aos="zoom-out-left">
                        <h4>JAVASCRIPT</h4>
